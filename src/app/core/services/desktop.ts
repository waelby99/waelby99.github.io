...
export class DesktopService {
   ...
   * New storage version.
   *
   * This avoids the wallpaper choices
   * we saved during previous tests.
   */
  ...
  /*
   * Add more wallpapers here whenever
   * you place images inside:
   *
  ...
  private readonly defaultIcons: DesktopIcon[] = [

    {
      ...
      icon:
        '/assets/icons/desktop/my-computer.png',
...

    {
      ...
      icon:
        '/assets/icons/desktop/my-documents.png',
...

    {
      ...
      icon:
        '/assets/icons/desktop/internet-explorer.png',
...

    {
      ...
      icon:
        '/assets/icons/desktop/projects.png',
...

    {
      ...
      icon:
        '/assets/icons/desktop/recycle-bin.png',
  ...
  applyWallpaper(
    ...
    this.currentWallpaperPosition.set(
      position
    );
